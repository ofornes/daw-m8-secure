...
| /var/local/volumes/moodle-data | moodle | 
|====================


=== Usuaris i passwords

.Usuaris i passwords de databases
[width="100%",options="header"]
|====================
| usuari | password | docker
| root | aNYYmCW4 | dbmysql
| wpadmin | 6wc4Pmjm | wordpress
| moodle | 4p6rCSPJ | moodle
|====================
